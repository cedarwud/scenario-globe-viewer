...
這頁不是外部資料來源；它只說明本簡報中的系統設定、測試數字與畫面基準，
可以在專案內哪裡查到。
...
| Ref | Source examples |
| --- | --- |
| [6] | Operator / network pages：KSAT、SES O3b mPOWER、Intelsat teleport chart、Eutelsat / OneWeb GEO-LEO pages、Telesat teleports。 |
| [7] | Teleport / facility profiles：World Teleport Association、USEI Vernon Valley、Skylogic、OTE / COSMOTE、Pivotel、SANSA、NRCan ISSF。 |
| [8] | Regulatory / public records：FCC IBFS filings、ITU filing pages where available、public address or facility listings。 |
| [9] | Public geospatial sources：Wikipedia / Wikidata station pages、SvalSat、TrollSat、Tromsø、Awarua 等 coordinate references。 |
| [10] | News / press evidence：SES、Eutelsat / OneWeb、Orange、Speedcast、Telespazio、NT Satellite、stc、Vivacom、SpaceNews。 |
