...
| F-18 | 畫面可穩定運行至少 `24 小時` | Phase 7.0 retained full-run artifact closes repo stability; this route should preserve smoke/regression confidence. | `bounded-repo-owned-seam` | Do not restate as route-specific live lock-in unless rerun for this route. |
