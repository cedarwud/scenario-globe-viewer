...
- Hierarchy fit: the visual-clarity proposal does not solve clutter by adding more color. It says, "reduce first, layer next, color last" in `/home/u24/papers/project/leo-beam-sim/docs/visual-clarity-proposal/README.md`.
