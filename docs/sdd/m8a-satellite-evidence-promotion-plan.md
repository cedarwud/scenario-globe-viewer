...
| ITRI requirement pressure for `LEO`, `MEO`, `GEO`, and TLE-driven orbit input | `itri/README.md` | explanatory-only | Explains why future satellite-source work may matter to the wider program. It does not authorize R1V real satellite rendering, MEO work, or non-R1V roadmap expansion. |
