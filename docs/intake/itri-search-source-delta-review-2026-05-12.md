# ITRI Search Source Delta Review
...
selection. They do not supply retained project traffic logs, ITRI private model
...
- ITRI ICT Journal NTN articles as ITRI official public context sources.
- ITRI procurement trace `A522000513` as an inaccessible official trace only.
...
- Any source that would require inferring ITRI's private orbit model, handover
...
| Public orbital proxy source | CelesTrak Current GP Element Sets, `https://celestrak.org/NORAD/elements/` | Add to register | F-03, F-13, F-15 context | Public GP/TLE/OMM source family for modeled or prerecorded orbital proxy scenarios. | Does not equal ITRI's self-developed orbit model and does not prove route-native scale acceptance. | No |
| Public orbital proxy source | CelesTrak GP data formats, `https://celestrak.org/NORAD/documentation/gp-data-formats.php` | Add to register | F-03, F-15 | Public data-format authority candidate for GP/TLE/OMM ingestion planning. | Does not specify ITRI's required input contract, refresh cadence, validation vectors, or acceptance truth. | No |
| Public orbital proxy source | CelesTrak Supplemental GP index, `https://celestrak.org/NORAD/elements/supplemental/` | Add to register | F-03, F-13, F-15 context | Public SupGP source family, including operator-supplied supplemental element-set context. | Does not provide ITRI equivalence approval or active satellite/path truth. | No |
...
| Official / first-party public context source | ESTNeT GitHub, `https://github.com/estnet-framework/estnet` | Add to register | F-01 context, V-03/V-04/V-05 method context, F-13 context | First-party ESTNeT code/repo context for OMNeT++ satellite and ground-station simulation. | Does not provide ITRI's model, NAT/bridge validation, DUT results, or project traffic evidence. | No |
| Official / first-party public context source | ESTNeT CEAS Space Journal paper, `https://link.springer.com/article/10.1007/s12567-020-00316-6` | Add to register as context only | F-01 context, V-03/V-04/V-05 method context | Original paper context for ESTNeT architecture and space-terrestrial simulation scope. | It is not the active repo or ITRI authority; it does not certify project validation. | No |
...
| Standards / protocol / methodology authority | RFC 792, `https://www.rfc-editor.org/rfc/rfc792.html` | Add to register | F-07/F-08 method context, V-03/V-04 method context | ICMP protocol basis for ping-style reachability checks. | Does not prove live ping passed and does not define ITRI thresholds. | No |
| Tool/vendor capability source | NE-ONE satellite link simulation, `https://itrinegy.com/solution-by-task/satellite-link-simulation/` | Add to register | V-06, F-09/F-10/F-11/F-16 capability context | Vendor capability context for repeatable satellite-link impairment emulation. | Does not provide ITRI scenario config, NE-ONE run output, DUT evidence, or measured project results. | No |
...
| ITRI official context source | ITRI ICT Journal: `3GPP NR NTN 通透模式基地台的現況與挑戰`, `https://ictjournal.itri.org.tw/xcdoc/cont?sid=0Q117558398226579056&xsmsid=0M236556470056558161` | Add to register | F-01, F-10/F-11, F-12/F-13 context | ITRI-owned technical context for 3GPP NR NTN transparent-mode base-station topics. | Does not publish the project orbit model, API, testbed topology, or validation artifacts. | No |
| ITRI official context source | ITRI ICT Journal: `天地一體：整合地面網路與衛星的智慧型閘道器`, `https://ictjournal.itri.org.tw/xcdoc/cont?sid=0P190429473194442849&xsmsid=0M236556470056558161` | Add to register | F-10/F-11, F-16 context | ITRI-owned context for TN/NTN integration, gateway, QoS, mobility, and multi-orbit concerns. | Does not define this route's implementation contract or pass/fail criteria. | No |
| ITRI official context source | ITRI ICT Journal: `衛星韌性金控應用`, `https://ictjournal.itri.org.tw/xcdoc/cont?sid=0Q118552727238318416&xsmsid=0M208578644085020215` | Add to register | F-07/F-08/F-09 context, V-02..V-06 context | Separate ITRI public case context for satellite-link resilience and measurement concepts. | Its numbers or observations are not current-project measured truth and cannot close this route. | No |
| ITRI official context source | ITRI ICT Journal: `3GPP NTN非地面網路通訊技術`, `https://ictjournal.itri.org.tw/xcdoc/cont?sid=0N347588371294333790&xsmsid=0M236556470056558161` | Add to register | F-01, F-10/F-11, F-12 context | ITRI-owned NTN technology context. | Does not provide a versioned ITRI orbit feed, handover API, or route acceptance criteria. | No |
| ITRI official context source | ITRI ICT Journal: `阿米巴基地台：軟體定義 3GPP - NTN 多軌技術`, `https://ictjournal.itri.org.tw/xcdoc/cont?sid=0P192517664504746384&xsmsid=0M208578644085020215` | Add to register | F-01, F-10/F-11 context | ITRI-owned context for software-defined 3GPP NTN multi-orbit technology. | Does not provide project rule presets, thresholds, or implementation authority for closure. | No |
| Inaccessible official trace | ITRI procurement trace `A522000513`, `https://quotaweb.itri.org.tw/download.aspx?filename=A522000513A+%E8%A6%8F%E7%AF%84%E6%9B%B8.pdf&rfqno=A522000513` | Add as inaccessible official trace only | F-01, F-10/F-11, F-17/P-01/P-02/P-03 context | Confirms an ITRI procurement/spec trace exists or existed. | The current public URL redirects to an expired inquiry page; spec content is not accessible and cannot be implementation authority. Ask ITRI for the valid spec. | No |
| Already covered | Existing INET / OMNeT++ emulation, TUN, NAT, PingApp, throughput sources in the register | Already covered | F-07/F-08/F-09 method context, V-02..V-06 method context | Official method/API context already retained in the register. | Does not provide ITRI topology or pass evidence. | No |
...
| Rejected / non-official / secondary / unverified | arXiv / IARIA / NetSim / EXata / Hypatia / sns3 / unrelated simulators | Reject for this register | F-01/V-03/V-04 context | Adjacent research only. | Not ITRI authority and not aligned enough to override ESTNeT/INET context. | No |
| Rejected / non-official / secondary / unverified | DTIC, Defense Alliance, MOENV, sustainability reports, and unrelated PDFs found in DOCX reports | Reject | None | None for this requirement closure question. | Off-topic or not source-authority for the ITRI V4 demo. | No |
...
- F-01 remains `external-validation-required`. Public 3GPP, CelesTrak,
  Space-Track, ESTNeT, and ITRI context sources still do not provide ITRI's
...
- F-16 remains bounded JSON export plus `external-validation-required`. Public
  RFC/iPerf/NE-ONE/ITRI context sources do not define an external report-system
...
- F-10/F-11 external-truth portions remain `external-validation-required`.
  3GPP trigger/procedure sources do not define ITRI or operator live policy,
...
- ITRI procurement `A522000513` spec content: the official URL was reachable
  only as an expired/inaccessible trace. It must be treated as "ask ITRI", not
...
pair-specific path, route-native `>=500 LEO`, ITRI orbit-model integration, or
