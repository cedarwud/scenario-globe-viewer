...
interface BootstrapPhysicalWindowSeed {
  startRatio: number;
  stopRatio: number;
  contextLabel: string;
...
const BOOTSTRAP_PHYSICAL_INPUT_PROVENANCE: ReadonlyArray<PhysicalInputProvenance> = [
  {
    family: "antenna",
    kind: "bounded-proxy",
...
const BOOTSTRAP_PHYSICAL_SOURCE_SEEDS: Record<
  string,
