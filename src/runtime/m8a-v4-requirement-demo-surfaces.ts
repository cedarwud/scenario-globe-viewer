...
export const M8A_V4_CUSTOMER_DEMO_VIEW_DEFAULT_FOCUS_VERSION =
  "requirement-demo-view-default-focus-runtime.v1";
export const M8A_V4_CUSTOMER_DEMO_VIEW_NARROW_VERSION =
  "requirement-demo-view-narrow-runtime.v1";
...
export const M8A_V4_CUSTOMER_REQUIREMENT_GAP_SURFACE_VERSION =
  "requirement-demo-route-requirement-gap-surface-runtime.v1";
export const M8A_V4_CUSTOMER_F09_RATE_SURFACE_VERSION =
  "requirement-demo-route-f09-rate-disposition-runtime.v1";
...
export const M8A_V4_CUSTOMER_F16_EXPORT_SURFACE_VERSION =
  "requirement-demo-route-f16-export-disposition-runtime.v1";
export const M8A_V4_CUSTOMER_F16_EXPORT_SCHEMA_VERSION =
  "requirement-demo-route-bounded-export.v1";
...
export const M8A_V4_CUSTOMER_POLICY_RULE_CONTROLS_VERSION =
  "requirement-demo-route-policy-rule-controls-runtime.v1";
...
export type M8aV4RequirementRequirementDisposition =
  | "true-route-closure"
  | "bounded-route-representation"
  | "bounded-repo-owned-seam"
  | "external-validation-required"
...
export type M8aV4RequirementRequirementGroupId =
...
export type M8aV4RequirementF10PolicyPreset =
  (typeof M8A_V4_CUSTOMER_F10_POLICY_PRESETS)[number];
export type M8aV4RequirementF10PolicyPresetId = M8aV4RequirementF10PolicyPreset["presetId"];
export type M8aV4RequirementF11RulePreset =
  (typeof M8A_V4_CUSTOMER_F11_RULE_PRESETS)[number];
export type M8aV4RequirementF11RulePresetId = M8aV4RequirementF11RulePreset["presetId"];
...
export interface M8aV4RequirementRequirementStatusGroup {
  groupId: M8aV4RequirementRequirementGroupId;
  label: string;
  disposition: M8aV4RequirementRequirementDisposition;
  status: "closed" | "bounded" | "open";
  requirementIds: readonly string[];
  routeClaim: string;
}

export interface M8aV4RequirementF16ExportRecord {
...
export interface M8aV4RequirementF16BoundedRateDisposition {
  requirementId: "F-09";
...
export interface M8aV4RequirementF16RouteExportBundle {
  ...
  requirementStatusGroups: ReadonlyArray<M8aV4RequirementRequirementStatusGroup>;
  f13ScaleReadiness: {
  ...
  f09BoundedRateDisposition: M8aV4RequirementF16BoundedRateDisposition;
  policyRuleControls: {
...
export function isM8aV4RequirementF10PolicyPresetId(
  value: string
): value is M8aV4RequirementF10PolicyPresetId {
  return M8A_V4_CUSTOMER_F10_POLICY_PRESETS.some(
    (preset) => preset.presetId === value
  );
}

export function isM8aV4RequirementF11RulePresetId(
  value: string
): value is M8aV4RequirementF11RulePresetId {
  return M8A_V4_CUSTOMER_F11_RULE_PRESETS.some(
    (preset) => preset.presetId === value
  );
}

export function resolveRequirementF10PolicyPreset(
...
export function resolveRequirementF11RulePreset(
...
] as const satisfies readonly M8aV4RequirementRequirementStatusGroup[];
...
export const M8A_V4_CUSTOMER_DEMO_VIEW_ACCEPTANCE_LAYER_VERSION =
  "requirement-demo-view-acceptance-layer-runtime.v1";
...
export const M8A_V4_CUSTOMER_F13_ROUTE_NATIVE_SCALE_READINESS_VERSION =
  "requirement-demo-route-f13-scale-readiness-runtime.v1";
...
export type M8aV4RequirementAcceptanceStatus =
  ...
  | "external-fail"
  | "external-evidence";
export type M8aV4RequirementAcceptanceDisposition =
  | "route-local-closed"
  | "bounded-route-representation"
...
export interface M8aV4RequirementAcceptanceCoverageRecord {
  requirementId: M8aV4RequirementRequirementId;
  primaryLayer: M8aV4RequirementAcceptanceLayerId;
  status: M8aV4RequirementAcceptanceStatus;
  disposition: M8aV4RequirementAcceptanceDisposition;
  surface: string;
  routeReality: string;
...
] as const satisfies readonly M8aV4RequirementAcceptanceCoverageRecord[];
