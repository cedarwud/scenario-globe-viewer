...
export const M8A_V4_CUSTOMER_DEMO_VIEW_FOCUS_COPY = {
  "leo-acquisition-context": {
    ...
    primaryFocusLabel: "W1 · LEO primary service",
    focusOrbitClassToken: "LEO",
    focusRole: "primary-service",
    briefingLine: "Focus on LEO: low-latency service is active; MEO/GEO are background only.",
    decisionNow: "LEO is the sole primary focus in this window.",
    decisionWhy: "Geometry supports LEO; pressure window has not started.",
    decisionWatch: "Watch the LEO focus cue and simulated service time, not measured throughput.",
    nextFocusHint: "Next focus: LEO quality drop.",
  ...
  "leo-aging-pressure": {
    ...
    primaryFocusLabel: "W2 · LEO pressure",
    focusOrbitClassToken: "LEO",
    focusRole: "pressure",
    briefingLine: "Focus on LEO pressure: quality is dropping; MEO is only the next candidate.",
    decisionNow: "LEO remains primary focus but is under modeled pressure.",
    decisionWhy: "Replay window shows geometry degrading; not measured jitter or latency.",
    decisionWatch: "Watch the countdown and quality-class drop; MEO does not steal primary focus.",
    nextFocusHint: "Next focus: MEO continuity hold.",
  ...
  "meo-continuity-hold": {
    ...
    primaryFocusLabel: "W3 · MEO continuity",
    focusOrbitClassToken: "MEO",
    focusRole: "continuity-hold",
    briefingLine: "Focus on MEO: it holds continuity; LEO return should not steal focus yet.",
    decisionNow: "MEO is in modeled hold state for this window.",
    decisionWhy: "LEO is no longer primary focus; MEO covers the middle with wider coverage.",
    decisionWatch: "Watch the MEO hold cue; no measured failover claim.",
    nextFocusHint: "Next focus: LEO returns as candidate.",
  ...
  "leo-reentry-candidate": {
    ...
    primaryFocusLabel: "W4 · LEO candidate",
    focusOrbitClassToken: "LEO",
    focusRole: "candidate-review",
    briefingLine: "Focus on candidate LEO: MEO is still holding; LEO is an evaluable return candidate.",
    decisionNow: "LEO returns to candidate focus; MEO continues to hold continuity.",
    decisionWhy: "Geometry has recovered to evaluable, but this is not an operator command.",
    decisionWatch: "Watch the candidate LEO cue contrast with the MEO hold.",
    nextFocusHint: "Next focus: GEO guard closes the sequence.",
  ...
  "geo-continuity-guard": {
    ...
    primaryFocusLabel: "W5 · GEO guard",
    focusOrbitClassToken: "GEO",
    focusRole: "guard-context",
    briefingLine: "Focus on GEO guard: it is guard-coverage semantic, not failover evidence.",
    decisionNow: "GEO is the final modeled guard context.",
    decisionWhy: "The sequence uses GEO to close the boundary; no failover pass is claimed.",
    decisionWatch: "Watch the guard wording; avoid reading it as a hardware switch.",
    nextFocusHint: "Restart: back to W1 LEO primary service.",
