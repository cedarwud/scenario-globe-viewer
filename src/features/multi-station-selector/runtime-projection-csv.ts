...
export function buildRuntimeProjectionCsv(result: RuntimeProjectionResult): string {
  ...
  for (const station of result.dataCompleteness.stationPrecision) {
    rows.push([
      ...
      station.elevationSourceAccessedUtc,
      station.elevationSourceKind,
      station.elevationDatasetId,
      station.elevationDatasetVersion,
      station.elevationDatasetResolutionM,
      station.elevationVerticalDatum,
      station.elevationTileId,
      station.elevationCellId,
      station.elevationSampleLat,
      station.elevationSampleLon,
      station.elevationSamplingMethod,
      station.elevationSampledAtUtc,
      station.elevationCacheGeneratedUtc,
      station.elevationLicenseId,
      station.elevationLicenseUrl,
