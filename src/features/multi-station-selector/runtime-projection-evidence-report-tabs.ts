// Evidence-report tab builders — the eight per-tab HTML assemblers plus their
// row / card / audit builders. Imports the leaf html-helpers; exports the
// build*Tab functions the renderer composes. Behavior guarded by the byte-
