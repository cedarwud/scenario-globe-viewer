export {
  CUSTOMER_F12_DECISION_INPUTS,
  CUSTOMER_F12_DECISION_THRESHOLD_AUTHORITY_PACKAGE_ROOT,
  CUSTOMER_F12_DECISION_THRESHOLD_AUTHORITY_PACKAGE_SCHEMA_VERSION,
  CUSTOMER_F12_DECISION_THRESHOLD_AUTHORITY_REVIEW_SCHEMA_VERSION,
  CUSTOMER_F12_MEASURED_REQUIREMENTS,
  CUSTOMER_F12_MEASURED_TRAFFIC_PACKAGE_ROOT,
  CUSTOMER_F12_REQUIREMENTS,
