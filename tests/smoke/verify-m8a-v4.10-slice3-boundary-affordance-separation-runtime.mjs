...
// the first-read layout to a left handover rail plus top scope strip. Slice 3
...
// retaining route, endpoint, precision, actor, source-boundary, boundary
// affordance, and forbidden-claim invariants.
