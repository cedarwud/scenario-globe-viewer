...
| Use footer `[模擬展示]` as simulation disclosure | pass | This replaces stale Truth-button wording. |
...
| --- | --- |
| Truth button is a cold-review affordance. | Truth button is removed; footer `[模擬展示]` carries ambient disclosure. |
